#
# Be sure to run `pod lib lint BAPKV.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'BAPKV'
  s.version          = '0.1.0'
  s.summary          = 'A persistent key-value store for iOS.'
...
A persistent key-value store for iOS, and it's also fast.
  ...
  s.source_files = 'BAPKV/Classes/**/*'
  
  # s.resource_bundles = {
  #   'BAPKV' => ['BAPKV/Assets/*.png']
  # }

  # s.public_header_files = 'Pod/Classes/**/*.h'
  # s.frameworks = 'UIKit', 'MapKit'
  s.dependency 'BAOCxxHash'
  s.dependency 'BAError'
end
